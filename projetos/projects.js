$(document).ready(function(){
    ...
    $.getJSON("./projetos/projects.json", function(lista){
        lista.forEach(function(objProject){
            //=======[card]===================//
            var card = $("#portfolio .container .row");
            ...
            html += "</div>"
            html += "</div>"
            html += "<img class=\"img-fluid\" src=\"projetos/img/cake.png\" alt=\"\">"
            html += "</div>"
            html += "</div>"
            ...
            html += "<img class=\"img-fluid img-centered\" src=\"projetos/img/cake.png\" alt=\"\">"
