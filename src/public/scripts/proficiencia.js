...
var createChar = (id, data, options) => {
...
var params_back_end = getBackEndParam(mobilecheck());
var params_front_end = getFrontEndParam(mobilecheck());
var params_tools = getToolsParam(mobilecheck());
